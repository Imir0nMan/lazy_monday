...
keys = [Key("start chrome /incognito facebook.com",1),AltKey("enter",0,0.1),Key("sample",2),AltKey("tab",0,0.1),Key("sample",0.1),AltKey("enter",0,0.1),AltKey("enter",0,2),AltKey("tab",10,5),AltKey("enter",0,0.2),AltKey("tab",4,0),AltKey("enter",0,0.5),Key("Ashot Gasparyan",1)]
